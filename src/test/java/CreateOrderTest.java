...
public class CreateOrderTest {
    ...
    @Test
    public void SuccessCreatingOrderTest() {
        orderClient = new OrderClient();
        //System.out.println(Ingredient.INGREDIENT_HAVE_OK_HASH.getIngredients()[0]);
        ValidatableResponse createResponse = OrderClient.createWithIngredients(accessToken, Ingredient.INGREDIENT_HAVE_OK_HASH);
    ...
    @Test
    public void unSuccessCreatingOrderWithoutAuthTest() {
        orderClient = new OrderClient();
    ...
    @Test
    public void unSuccessCreatingOrderWithoutIngredientsTest() {
        orderClient = new OrderClient();
    ...
    @Test
    public void unSuccessCreatingOrderWithBadIngredientsTest() {
        orderClient = new OrderClient();
        ValidatableResponse createResponse = OrderClient.createWithBadIngredients(accessToken);
        var statusCode = createResponse.extract().statusCode();
        assertThat("Order can be created with bad ingredients", statusCode, equalTo(500));
    }
